-- Generated from Combined_PDFs
-- Date: 2025-12-19T10:59:40.371888
-- Total: 1402 products
...
BEGIN
    ...
    VALUES ('Combined_PDFs', 'combined_pdfs', 'GB')
    ON CONFLICT (slug) DO NOTHING;
    SELECT id INTO v_supp_id FROM suppliers WHERE slug = 'combined_pdfs';
