...
### ✅ מערכת ניהול "אבות מוצר" ובינה מלאכותית (Master Products & AI)
**חידושים**:
- ✅ **מנגנון איחוד אוטומטי**: מנוע מבוסס Gemini LLM לזיהוי וקיבוץ מוצרים זהים מרשתות שונות.
- ✅ **דיוק גבוה (שוקולד זה לא וניל!)**: הוספת זיהוי טעמים, ניחוחות ומשקלים למניעת טעויות איחוד.
- ✅ **ממשק ניהול משופר**: הוספת תפריט ניווט אחיד, כפתור מפה, ועדכון קישורים בכל המערכת.
- ✅ **אישור מהיר (Bulk)**: קיבוץ הצעות לפי מוצר אב עם אפשרות לאישור קבוצתי או דחייה פרטנית (עם ה-❌ האדום).
- ✅ **איחוד ידני (Merge)**: כלי למיזוג אבות מוצר כפולים במערכת.
